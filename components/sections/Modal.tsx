	...
	return (
		<Dialog>
			...
			<DialogPortal>
				...
				<DialogContent className='p-2 md:p-10 rounded-xl min-w-[80vw] max-w-[95vw] 2xl:min-w-[1440px] bg-gray-100 lg:rounded-[45px] overflow-y-auto max-h-[95vh]'>
					<DialogHeader>
					...
					<div className='grid gap-4 2xl:gap-0 2xl:grid-cols-2 grid-cols-1 bg-gray-100 rounded-[45px]'>
						...
						<div className='relative 2xl:min-h-[856px] h-[50vw]'>
							<Image
								fill
